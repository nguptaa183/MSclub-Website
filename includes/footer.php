      ...
      <div class="row">
        <div class="col-lg-6 h-100 text-center text-lg-left my-auto">
          <ul class="list-inline mb-2">
            ...
            <li class="list-inline-item">&sdot;</li>
            <li class="list-inline-item">
              <a class="js-scroll-trigger" href="#team">Teams</a>
            </li>
            <li class="list-inline-item">&sdot;</li>
            <li class="list-inline-item">
          ...
          <p class="text-muted small mb-4 mb-lg-0">&copy; 2018 All Rights Reserved | Microsoft Campus Club | Technical Society, NIT Rourkela
            <br>Developed by
            <strong>
              <a href="https://ngupta.me" target="_blank">Nikhil Gupta</a>
            </strong>
          </p>
        ...
        <div class="col-lg-6 h-100 text-center text-lg-right my-auto">
          <ul class="list-inline mb-0">
            <li class="list-inline-item mr-3">
              <a href="https://www.facebook.com/MicrosoftCampusClub/" target="_blank">
